...
const styles = StyleSheet.create({
  ...
  button: { backgroundColor: "#3f3f46", borderRadius: 7, minHeight: 38, paddingHorizontal: 14, alignItems: "center", justifyContent: "center" },
  buttonDisabled: { opacity: 0.6 },
  buttonText: { color: "#e4e4e7", fontSize: 13, fontWeight: "900" },
